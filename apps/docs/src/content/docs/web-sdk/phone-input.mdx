...
A [`RegionPicker`](/web-sdk/region-picker/) created with the phone hands a pick to
[`setRegion`](#setregion) and follows the resolved [`region`](#phoneinputstate) back.
[`attachRegionPicker`](/web-sdk/region-picker/#attachregionpicker) wires the DOM. The full field,
with a live demo, is in [Build the complete field](/web-sdk/guides/complete-field/).
