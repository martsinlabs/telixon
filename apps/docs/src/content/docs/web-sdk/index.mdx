...
[`RegionList`](/web-sdk/region-list/) feeds region pickers. A standalone
[flag sprite](/web-sdk/flags/) shows a flag for every region on every platform. Try the widgets
together in the [input playground](/playground/input/).
