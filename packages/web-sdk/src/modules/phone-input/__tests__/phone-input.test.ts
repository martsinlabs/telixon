...
describe('PhoneInput createPhoneInput: input type', () => {
  it('accepts an <input type="text"> element', () => {
    ...
    expect(() => createPhoneInput({ input, mode: 'national', defaultRegion: 'US' })).not.toThrow();
  ...
  it('rejects an <input type="email"> element', () => {
    ...
    expect(() => createPhoneInput({ input, mode: 'national', defaultRegion: 'US' })).toThrow(/type="email"/);
  ...
  it('rejects an <input type="number"> element', () => {
    ...
    expect(() => createPhoneInput({ input, mode: 'national', defaultRegion: 'US' })).toThrow(/type="number"/);
