import { getRegionIndex, MetadataNumberType } from '@telixon/core/engine';
...
export function isGeneralDescProfile(profile: NumberTypeProfileRef): boolean {
  ...
  const countryIndex: number = getRegionIndex(resourceProvider.countryScopeLayer, profile.stateCountryIndex);
