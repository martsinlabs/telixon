...
const TERRITORIES_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.METADATA.FOLDER}/${ENGINE_LAYOUT.METADATA.FILES.TERRITORIES}`;
const GRAPH_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.DFA.FOLDER}/${ENGINE_LAYOUT.DFA.FILES.GRAPH}`;
const CALLING_CODES_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.DFA.FOLDER}/${ENGINE_LAYOUT.DFA.FILES.CALLING_CODES}`;
const COUNTRY_SCOPE_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.DFA.FOLDER}/${ENGINE_LAYOUT.DFA.FILES.COUNTRY_SCOPE}`;
const NUMBER_TYPE_SCOPE_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.DFA.FOLDER}/${ENGINE_LAYOUT.DFA.FILES.NUMBER_TYPE_SCOPE}`;
const NUMBER_TYPE_PROFILE_PATH: string = `${ENGINE_LAYOUT.ROOT}/${ENGINE_LAYOUT.DFA.FOLDER}/${ENGINE_LAYOUT.DFA.FILES.NUMBER_TYPE_PROFILE}`;
